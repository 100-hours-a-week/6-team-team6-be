...
public enum ExceptionCode {
    ...
    NOTIFICATION_ALREADY_DELETED("NOTIFICATION02", 404),
    NOTIFICATION_NOT_OWNED("NOTIFICATION03", 403),

    // keyword subscription
    KEYWORD_SUBSCRIPTION_ALREADY_EXISTS("KEYWORD01", 409),
    KEYWORD_SUBSCRIPTION_EXCEED_LIMIT("KEYWORD02", 409),
    KEYWORD_SUBSCRIPTION_ALREADY_DELETE("KEYWORD03", 404),
    KEYWORD_SUBSCRIPTION_NOT_FOUND("KEYWORD04", 404),
    KEYWORD_SUBSCRIPTION_NOT_OWNED("KEYWORD05", 403),
    ...
    // ai
    AI_POST_VIOLENCE_VIOLATION("AI01", 400),
    AI_POST_SEXUAL_SHAME("AI02", 400),
    AI_POST_SEXUAL_EXPOSURE("AI03", 400),
    AI_POST_AVERSION("AI04", 400),
    AI_POST_TORMENT("AI05", 400),
    AI_POST_PROHIBITED_ITEMS("AI06", 400),
    AI_RECOMMENDATION_RETRIEVE_FAILED("AI07", 400),
