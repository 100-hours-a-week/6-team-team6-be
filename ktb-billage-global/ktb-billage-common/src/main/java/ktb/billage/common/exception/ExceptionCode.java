...
public enum ExceptionCode {
    ...
    // ai
    AI_POST_VIOLENCE_VIOLATION("S1", 400),
    AI_POST_SEXUAL_SHAME("S2", 400),
    AI_POST_SEXUAL_EXPOSURE("S3", 400),
    AI_POST_AVERSION("S4", 400),
    AI_POST_TORMENT("S5", 400),
    AI_POST_PROHIBITED_ITEMS("S11", 400),
    AI_RECOMMENDATION_RETRIEVE_FAILED("AI01", 400),
